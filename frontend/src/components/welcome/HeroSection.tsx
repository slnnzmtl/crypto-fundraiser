      ...
      <header className="max-w-[1200px] mx-auto px-12 py-16 rounded-2xl bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
        <div className="animate-fadeIn max-w-[1400px] mx-auto">
          ...
          <p className="text-center text-lg md:text-xl xl:text-2xl text-gray-200 mb-12 mx-auto font-light leading-relaxed">
            <span>Join our community and start exploring the world of decentralized fundraising</span>
            <br />
            <span className="text-yellow-400 text-sm">It's a pet-project to demonstrate my skills in React, Typescript, MobX, Tailwind, and Web3</span>
          </p>
          <button
            onClick={onConnectWallet}
            disabled={isConnecting}
            className={
              `group bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-bold 
              ...
              hover:shadow-yellow-500/40 ${isConnecting ? 'opacity-75 cursor-not-allowed' : 'hover:scale-105 hover:-translate-y-1 hover:from-yellow-600 hover:to-yellow-700'}`
            }
          >
