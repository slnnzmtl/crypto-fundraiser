...
const MetaMaskLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      d="m278.3 114.2 8.5-40.8-12.7-37.9-96.2 71.4 37 31.3 52.3 15.3 11.6-13.5-5-3.6 8-7.3-6.2-4.8 8-6.1zM31.8 73.4l8.5 40.8-5.4 4-6.2 4.8 8 7.3-5 3.6 11.6 13.5 52.3-15.3 37-31.3-96.2-71.4z"
    />
    <path
